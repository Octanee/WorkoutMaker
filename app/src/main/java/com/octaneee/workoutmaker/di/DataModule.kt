...
import com.octaneee.workoutmaker.data.database.WorkoutDatabaseCallback
...
object DataModule {
    ...
    @Singleton
    @Provides
    fun provideWorkoutMakerDatabase(
        @ApplicationContext app: Context,
        callback: WorkoutDatabaseCallback
    ...
    @Singleton
    @Provides
    fun provideTrainingExerciseCrossRefDao(database: WorkoutMakerDatabase) =
        database.getTrainingExerciseCrossRefDao()
