package com.octaneee.workoutmaker.ui.main.fragment.plan.training_list
...
import com.octaneee.workoutmaker.ui.bottom_sheet.microcycle.MicrocycleBottomSheetFragment
...
class TrainingListFragment : Fragment(R.layout.fragment_training_list), ItemListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.microcycle.observe(viewLifecycleOwner, {
            ...
            microcycleBottomSheetFragment.setup(it.microcycleName, it.numberOfDays)
    ...
    override fun onMicrocycleBottomSheetFragmentSaveButtonClick(
        ...
        if (!TextUtils.isEmpty(microcycleName)) {
            item.microcycleName = microcycleName
        }
        item.numberOfDays = microcycleNumberOfDays
